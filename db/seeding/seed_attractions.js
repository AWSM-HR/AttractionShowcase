...
const filename = argv.output || 'attractions.csv';
...
const createAttraction = () => {
  ...
  return `${attractionTitle},${city},${reviews},${relativeRanking1},${relativeRanking2},${ratio},${attractionType},${description},${isOpen},${suggestedDuration},${address},${travelersChoiceAward},${likedStatus},${ticketPrice},${averageRating}\n`;
};
...
stream.write('attractionTitle,city,reviews,relativeRanking1,relativeRanking2,ratio,attractionType,description,isOpen,suggestedDuration,address,travelersChoiceAward,linkedStatus,ticketPrice,averageRating\n', 'utf-8');
